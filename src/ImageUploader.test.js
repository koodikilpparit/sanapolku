...
describe('ImageUploader tests', () => {
    ...
    it('should allow user to upload a valid image and update the preview', async () => {
        ...
        const fileReaderMock = {
            ...
            readAsDataURL: function() {
                ...
                if (this.onload) {
                    this.onload({ target: { result: 'data:image/png;base64,ZHVtbXkgY29udGVudA==' } });
                }
            },
        };
        ...
        await waitFor(() => {
            ...
            expect(imgPreview.src).toContain('data:image/png;base64,ZHVtbXkgY29udGVudA=='); 
        });
    });
    ...
    it('should alert if invalid file type is uploaded', () => {
        ...
        expect(global.alert).toHaveBeenCalledWith('Vain JPEG, JPG tai PNG tiedostot hyväksytään.');
    });
